...
ab -g ${PREFIX}-hello1.tsv -n 10000 -c 10 "$ADDR1"
sleep 10
ab -g ${PREFIX}-hello2.tsv -n 50000 -c 50 "$ADDR1"
sleep 10
...
ab -g ${PREFIX}-fib1.tsv -n 10000 -c 10 "$ADDR2"
sleep 10
ab -g ${PREFIX}-fib2.tsv -n 50000 -c 50 "$ADDR2"
sleep 10
...
ab -g ${PREFIX}-resize1.tsv -n 1000 -c 10 -p $3 -T image/jpeg "$ADDR3"
sleep 10
ab -g ${PREFIX}-resize2.tsv -n 5000 -c 50 -p $3 -T image/jpeg "$ADDR3"
sleep 10
